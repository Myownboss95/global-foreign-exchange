        ...
        <div class="card mb-xl-0 shadow-lg">
            <div class="card-body">
                <div class="p-2">
                    ...
                    <h5 class="mt-3">{{format_money(plan.min_investment)}} - {{format_money(plan.max_investment)}}
                    <br>
                    <small class="text-muted font-size-14 fw-medium">Investment Amount</small></h5>
